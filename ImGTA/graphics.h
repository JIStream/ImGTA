/*
ADAPTED FROM https://github.com/videogame-hacker/StuntJumpPractice/blob/master/graphics.h
*/
...
void drawTri(Vector3 pos1, Vector3 pos2, Vector3 pos3) {
...
void drawAngledAreaWireframe(Vector3 boxStart, Vector3 boxEnd, float boxWidth, int r, int g, int b, int a)
{
	Vector3 start = boxStart, end = boxEnd;
	float width = abs(boxWidth) / 2.f;
...
void drawAngledArea(Vector3 boxStart, Vector3 boxEnd, float boxWidth, int r, int g, int b, int a)
{
	Vector3 start = boxStart, end = boxEnd;
	float width = abs(boxWidth) / 2.f;
